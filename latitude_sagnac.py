...
latitude = float(input("A quelle latitude vous trouvez-vous ?"))
...
w=v/r_latitude     # w la vitesse angulaire à la latitude


print("\n\nle périmètre de cette latitude est de", perimetre / 1000, "km et la vitesse a cette latitude est ", round(v), "m/s",
      "soit", round(v * 3.6), "km/h")
print("\n\nle rayon à cette latitude est de ", r_latitude / 1000, "km")  # rayon à la latitude donnée en km
print("\n\nla vitesse angulaire est de w=", w, "rad/s")

print("\n\nla valeur de la vitesse angulaire ne dépend donc pas de la latitude, elle est la même \n"
      "pour tout corps sur terre peu importe sa position géographique")
